...
| `mistralai/mistral-large-2407` | **Yes** (200 with require_parameters, provider Mistral) | Mistral Large 2, 123B dense, MRL non-commercial weights, $2.00/$6.00, sole endpoint (Mistral first party, probed 2026-07-29). Added to the study as the 13th model: previous-generation dense flagship, generation contrast to Medium 3.5. Clean BERTScore temperature response in its data (0.755 to 0.708), so the parameter verifiably reaches the model |

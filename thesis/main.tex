...
% BDI removed -- internal shorthand, not a published instrument
...
In accordance with the AI Tools Guidelines of the University of Osnabr\"uck, the following describes how AI tools were used in this thesis.

I briefly used Cursor for pipeline development. My primary tool was Claude 4.6 (Anthropic)\footnote{\href{https://claude.ai}{https://claude.ai}}, used for data visualisation and debugging. I also used Gemini occasionally for brainstorming. As English is not my first language, I used these tools to refine phrasing where my original formulations lacked precision.

All code was reviewed before inclusion. All arguments, interpretations, and conclusions are my own.

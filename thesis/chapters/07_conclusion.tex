...
\begin{enumerate}
  ...
  \item \textbf{The \gls{eu}-sovereign model is close to proprietary ones
...
layer. Neither BERTScore nor coherence alone would have been enough to
revealed that. The cross-model comparison (Contribution~2) shows that

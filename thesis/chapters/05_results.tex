...
\paragraph{Proprietary models show the most stable temperature profiles.}
\modelname{GPT-5.4} and \modelname{Sonnet~4.6} maintain mean Jaccard
between $0.82$ and $0.92$ across all temperatures with no significant
temperature trend. Both models also show narrower strategy distributions
(\autoref{fig:strategy-dist}), which likely contributes.

\paragraph{Most open-weight models peak at low temperatures.}
\modelname{Qwen~3.5~122B} and \modelname{OLMo~3.1~32B} achieve $J = 1.0$
at $T = 0.0$ but decline at higher temperatures. The Mistral family peaks
between $T = 0.075$ and $T = 0.15$: \modelname{Mistral~Small~3.2} reaches
$J = 0.938$ at $T = 0.075$, \modelname{Mistral~Large~3} reaches $J = 0.848$
at $T = 0.15$, and \modelname{Mistral~Small~4} reaches $J = 0.881$ at
$T = 0.15$. All three Mistral models score lower at $T = 0.0$ than at
their peak.
...
\begin{figure}[t]
  ...
  \caption{Plan consistency (median Jaccard) versus response similarity

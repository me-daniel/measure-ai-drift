...
Method~1 measures whether the model selects the same therapeutic
strategies across independent trials by extracting strategy sets from the
\techil{<plan>} block of each trial and comparing them with pairwise
Jaccard similarity:
...
active parameters, Apache~2.0), the \gls{eu}-sovereign model that
reDreamAI would deploy in production. Two additional Mistral

...
\begin{enumerate}
  ...
  \item The findings are robust to model-set enlargement, and the framework is cheap to extend. Mistral Medium~3.5, added post hoc with one configuration entry on identical inputs, topped the stability ranking as an EU-sovereign open-weight model, and every substantive finding survived.
\end{enumerate}
